$(function() {
  ...
  $(document.body).ready(() => {
    ...
    for (var i = 0; i < images.length; i++) {
      var img = images[i];
      $(img).css({ width: "auto", position: "relative", margin: "0 auto" });
    }
  });
  // var images = $(".img");
  // console.log(images);
  ...
  //   }
  // });
  // $(images[0]).css({ width: "auto", position: "relative", margin: "0 auto" });
  // $(images[1]).css({ width: "auto", position: "relative", margin: "0 auto" });
  // $(images[2]).css({ width: "auto", position: "relative", margin: "0 auto" });
});
