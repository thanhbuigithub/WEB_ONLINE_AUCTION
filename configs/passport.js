  ...
  passport.use(
    ...
    new LocalStrategy(
      ...
      (req, username, password, done) => {
        ...
        req
          .checkBody("username", "Vui lòng điền thông tin User Name !")
          .notEmpty();
        req.checkBody("dob", "Vui lòng điền thông tin ngày sinh !").notEmpty();
        req
          .checkBody("email", "Vui lòng điền thông tin Email !")
          .notEmpty()
          .isEmail();
        ...
        req
          .checkBody(
            "password",
            ("Vui lòng điền mật khẩu, phải ít nhât %d kí tự",
        ...
        req
          .checkBody("password", "Mật khẩu không trùng khớp, thử lại !")
          .equals(req.body.raw_Comfirm);
        req
          .checkBody(
            "accept",
            "Bạn phải chấp nhận các điều khoản của chúng tôi !"
          )
          .equals("1");
          ...
          (err, user) => {
            ...
            if (user) {
              return done(null, false, {
                message: "Tên đăng nhập đã tồn tại, vui lòng thử với tên khác !"
              });
            }
            ...
            newUser.info.dob = moment(req.body.dob, "DD/MM/YYYY").format(
              "YYYY-MM-DD"
            );
            ...
            newUser.status =
              settings.confirmRegister == 1 ? "INACTIVE" : "ACTIVE";
  ...
  passport.use(
    ...
    new LocalStrategy(
      ...
      function(req, username, password, done) {
        req
          .checkBody("f_Username", "Tên đăng nhập không hợp lệ , thử lại !")
          .notEmpty();
        req
          .checkBody("password", "Mật khẩu không hợp lệ, thử lại !")
          .notEmpty();
